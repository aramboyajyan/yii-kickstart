...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php print Yii::app()->theme->baseUrl; ?>/assets/css/screen.css" media="screen, projection" />
	<link rel="stylesheet" type="text/css" href="<?php print Yii::app()->theme->baseUrl; ?>/assets/css/print.css" media="print" />
	<!--[if lt IE 8]>
	<link rel="stylesheet" type="text/css" href="<?php print Yii::app()->theme->baseUrl; ?>/assets/css/ie.css" media="screen, projection" />
	<![endif]-->

	<link rel="stylesheet" type="text/css" href="<?php print Yii::app()->theme->baseUrl; ?>/assets/css/main.css" />
	<link rel="stylesheet" type="text/css" href="<?php print Yii::app()->theme->baseUrl; ?>/assets/css/form.css" />
